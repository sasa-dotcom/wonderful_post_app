# -*- encoding: utf-8 -*-
# stub: actioncable 6.1.7.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v6.1.7.1/actioncable/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v6.1.7.1/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/rails/tree/v6.1.7.1/actioncable" } if s.respond_to? :metadata=
