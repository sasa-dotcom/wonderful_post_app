class SampleArticlesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sample_article.save
        format.html { redirect_to @sample_article, notice: "Sample article was successfully created." }
  ...
  def update
    respond_to do |format|
      if @sample_article.update(sample_article_params)
        format.html { redirect_to @sample_article, notice: "Sample article was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sample_articles_path, status: :see_other, notice: "Sample article was successfully destroyed." }
